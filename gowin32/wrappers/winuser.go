...
func GetMonitorInfo(hMonitor syscall.Handle, lpmi *MONITORINFOEX) bool {
	ret, _, _ := syscall.Syscall(procGetMonitorInfo.Addr(), 2,
		uintptr(hMonitor),
...
func EnumDisplaySettingsEx(szDeviceName *uint16, iModeNum uint32, devMode *DEVMODE) bool {
	ret, _, _ := syscall.Syscall(procEnumDisplaySettingsW.Addr(), 3,
